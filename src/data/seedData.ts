...
export const SEED_USERS: User[] = [
  ...
  {
    id: 'USR-003',
    name: 'Elena Santos-Mendoza (Finance Officer)',
...
export const SEED_EMPLOYEES: Employee[] = [
  // 1. Barangay Officials (3)
  {
    ...
    emergency_contact: 'Lourdes Ramos (Spouse)',
  ...
  },
  {
    ...
    suffix: '',
    employee_type: 'Official',
    position: 'Barangay Kagawad (Appropriation)',
    basic_salary: 21000,
    allowance: 3500,
    date_hired: '2023-11-01',
    status: 'Active',
    ...
    email: 'elena.mendoza@sf2.gov.ph',
    emergency_contact: 'Mateo Mendoza (Brother)',
...
export const DEFAULT_SETTINGS: PayrollSettings = {
  ...
  punong_barangay: 'Hon. Fernando A. Ramos',
  barangay_treasurer: 'Elena S. Mendoza',
